...
#' @param celltype Celltype to be calculated.
...
#' @param celltype Celltype to be calculated.
#' @param signature Signature name corresponding to cell type.
#' @param cell.threshold The cell number threshold for this cell type. Default set to 100.
#'
